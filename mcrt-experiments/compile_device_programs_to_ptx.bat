"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin\nvcc.exe" -ptx mcrt-experiments/devicePrograms.cu -I "C:\ProgramData\NVIDIA Corporation\OptiX SDK 7.5.0\include" -I "3rdparty/glm" --generate-line-info -use_fast_math -o mcrt-experiments/devicePrograms.ptx
...
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin\nvcc.exe" -ptx mcrt-experiments/directLightingShaders.cu -I "C:\ProgramData\NVIDIA Corporation\OptiX SDK 7.5.0\include" -I "3rdparty/glm" --generate-line-info -use_fast_math -o mcrt-experiments/directLightingShaders.ptx
