...
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin\bin2c.exe" -c --padd 0 --type char --name embedded_ptx_code_radiance_cell_gathering_cubemap mcrt-experiments/radianceCellGathering_Cubemap_Octree.ptx > mcrt-experiments/radianceCellGathering_Cubemap_embedded_octree.c 
...
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin\bin2c.exe" -c --padd 0 --type char --name embedded_ptx_code_radiance_cell_scattering_cube_map mcrt-experiments/radianceCellScattering_Cubemap_hybrid_Octree.ptx > mcrt-experiments/radianceCellScattering_Cubemap_embedded_octree.c  
