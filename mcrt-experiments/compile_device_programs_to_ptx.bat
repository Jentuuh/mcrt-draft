...
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin\nvcc.exe" -ptx mcrt-experiments/radianceCellGathering3.cu -I "C:\ProgramData\NVIDIA Corporation\OptiX SDK 7.6.0\include" -I "3rdparty/glm" -I "3rdparty/nvidia" --generate-line-info -use_fast_math -o mcrt-experiments/radianceCellGathering2.ptx
...
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8\bin\nvcc.exe" -ptx mcrt-experiments/radianceCellScattering_last.cu -I "C:\ProgramData\NVIDIA Corporation\OptiX SDK 7.6.0\include" -I "3rdparty/glm" -I "3rdparty/nvidia" --generate-line-info -use_fast_math -o mcrt-experiments/radianceCellScattering.ptx
