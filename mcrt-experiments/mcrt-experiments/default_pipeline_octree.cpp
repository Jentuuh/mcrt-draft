...
namespace mcrt {
    extern "C" char embedded_ptx_code_octree[];
    ...
    DefaultPipelineOctree::DefaultPipelineOctree(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene) : McrtPipeline(context, geometryBuffers, scene) {
    ...
    void DefaultPipelineOctree::uploadLaunchParams()
    {
        launchParamsBuffer.upload(&launchParams, 1);
    }


    void DefaultPipelineOctree::buildModule(OptixDeviceContext& context)
    {
        ...
        const std::string ptxCode = embedded_ptx_code_octree;
    ...
    void DefaultPipelineOctree::buildDevicePrograms(OptixDeviceContext& context)
    {
        //---------------------------------------
        //  RAYGEN PROGRAMS
        //---------------------------------------
    ...
    void DefaultPipelineOctree::buildSBT(GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
        // ----------------------------------------
    ...
    void DefaultPipelineOctree::buildPipeline(OptixDeviceContext& context)
    {
    ...
    OptixTraversableHandle DefaultPipelineOctree::buildAccelerationStructure(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
