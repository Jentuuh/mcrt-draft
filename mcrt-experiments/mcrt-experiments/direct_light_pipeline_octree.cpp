...
namespace mcrt {
    extern "C" char embedded_ptx_code_direct_lighting_gathering_octree[];
    ...
    DirectLightPipelineOctree::DirectLightPipelineOctree(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene) : McrtPipeline(context, geometryBuffers, scene)
    {
    ...
    void DirectLightPipelineOctree::uploadLaunchParams()
    {
        launchParamsBuffer.upload(&launchParams, 1);
    }


    void DirectLightPipelineOctree::buildModule(OptixDeviceContext& context)
    {
        ...
        const std::string ptxCode = embedded_ptx_code_direct_lighting_gathering_octree;
    ...
    void DirectLightPipelineOctree::buildDevicePrograms(OptixDeviceContext& context)
    {
        //---------------------------------------
        //  RAYGEN PROGRAMS
        //---------------------------------------
    ...
    void DirectLightPipelineOctree::buildSBT(GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
        // ----------------------------------------
    ...
    void DirectLightPipelineOctree::buildPipeline(OptixDeviceContext& context)
    {
    ...
    OptixTraversableHandle DirectLightPipelineOctree::buildAccelerationStructure(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
