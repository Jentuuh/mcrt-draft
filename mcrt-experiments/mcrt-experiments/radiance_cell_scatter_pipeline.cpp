...
namespace mcrt {
    extern "C" char embedded_ptx_code_radiance_cell_scattering[];
	...
	RadianceCellScatterPipeline::RadianceCellScatterPipeline(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene) : McrtPipeline(context, geometryBuffers, scene)
	{
    ...
    void RadianceCellScatterPipeline::buildModule(OptixDeviceContext& context)
    {
    ...
    void RadianceCellScatterPipeline::buildDevicePrograms(OptixDeviceContext& context)
    {
        //---------------------------------------
        //  RAYGEN PROGRAMS
        //---------------------------------------
    ...
    void RadianceCellScatterPipeline::buildSBT(GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
        // ----------------------------------------
    ...
    void RadianceCellScatterPipeline::buildPipeline(OptixDeviceContext& context)
    {
    ...
    OptixTraversableHandle RadianceCellScatterPipeline::buildAccelerationStructure(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
        return NULL;
    }
