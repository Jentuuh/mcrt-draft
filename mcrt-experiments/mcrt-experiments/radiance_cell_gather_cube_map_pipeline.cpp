...
namespace mcrt {
    ...
    extern "C" char embedded_ptx_code_radiance_cell_gathering_cubemap[];
    ...
    void RadianceCellGatherCubeMapPipeline::uploadLaunchParams()
    {
    ...
    void RadianceCellGatherCubeMapPipeline::buildModule(OptixDeviceContext& context)
    {
        ...
        const std::string ptxCode = embedded_ptx_code_radiance_cell_gathering_cubemap;
    ...
    void RadianceCellGatherCubeMapPipeline::buildDevicePrograms(OptixDeviceContext& context)
    {
        //---------------------------------------
        //  RAYGEN PROGRAMS
        //---------------------------------------
    ...
    void RadianceCellGatherCubeMapPipeline::buildPipeline(OptixDeviceContext& context)
    {
    ...
    OptixTraversableHandle RadianceCellGatherCubeMapPipeline::buildAccelerationStructure(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene)
    {
