...
namespace mcrt {
	class RadianceCellScatterUnbiasedPipeline : public McrtPipeline
	{
		public:
			RadianceCellScatterUnbiasedPipeline(OptixDeviceContext& context, GeometryBufferHandle& geometryBuffers, Scene& scene);
			void uploadLaunchParams() override;

			LaunchParamsRadianceCellScatterUnbiased launchParams;
